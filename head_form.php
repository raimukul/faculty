                               ...
                               <h4><input  class="form-control"  type="text" name="position" placeholder="Position e.g Assistant Professor (Department of ...?..)" value="<?php echo $position;?>"></h4>
                                <h6>
									...
									<select class="form-control" name="school">
										...
										<option value="University School Of Buddhist Studies & Civilization" <?php if ($school == 'University School Of Buddhist Studies & Civilization') { echo 'selected';} ?>>University School Of Buddhist Studies & Civilization</option>
										<option value="University School Of Vocational Studies & Applied Sciences" <?php if ($school == 'University School Of Vocational Studies & Applied Sciences') { echo 'selected';} ?>>University School Of Vocational Studies & Applied Sciences</option>
										...
										<option value="University School Of Low, Justice & Governance"  <?php if ($school == 'University School Of Low, Justice & Governance') { echo 'selected';} ?>>University School Of Law, Justice & Governance</option>
									</select>	

                                	<!-- <input  class="form-control"  type="text" name="school" placeholder="School e.g- SOICT or SOM ....." value=""> --></h6>
